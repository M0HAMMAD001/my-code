...
// Fetch products for Core Systems category
try {
    $stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'Core Systems'");
    $stmt->execute();
...
<head>
    ...
    <title>Core Systems - SEGMA STORE</title>
</head>
<body>
    <header class="header">
        <div class="logo">
    ...
    <main>
        <section class="category-header">
            <h1>Core Systems</h1>
            <p>High-performance gaming PCs and consoles for the ultimate gaming experience</p>
        </section>
