...
// Fetch products for Visuals Hub category
try {
    $stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'Visuals Hub'");
    $stmt->execute();
...
<head>
    ...
    <title>Visuals Hub - SEGMA STORE</title>
</head>
<body>
    <header class="header">
        <div class="logo">
    ...
    <main>
        <section class="category-header">
            <h1>Visuals Hub</h1>
            <p>Premium gaming monitors for the ultimate visual experience</p>
        </section>
