...
// Fetch products for Sound Zone category
try {
    $stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'Sound Zone'");
    $stmt->execute();
...
<head>
    ...
    <title>Sound Zone - SEGMA STORE</title>
</head>
<body>
    <header class="header">
        <div class="logo">
    ...
    <main>
        <section class="category-header">
            <h1>Sound Zone</h1>
            <p>Premium headsets and audio equipment for immersive gaming</p>
        </section>
