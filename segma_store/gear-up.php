...
// Fetch products for Gear Up category
try {
    $category = $_GET['category'] ?? 'Gear Up';
...
<head>
    ...
    <title>Gear Up - SEGMA STORE</title>
</head>
<body>
    <header class="header">
        <div class="logo">
    ...
    <main>
        <section class="category-header">
            <h1>Gear Up</h1>
            <p>Essential accessories to complete your gaming setup</p>
        </section>
